//! Bauta's masking constructions, in Rust.
//!
//! The Python implementation in `bauta/masking.py` is the reference.
...
//! `bauta-rs`, which holds every conversion and every unsafe boundary.
